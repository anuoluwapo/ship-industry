...
<body>
	...
	<section class="destination">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h2 class="text-center w3layouts w3 w3l w3ls">CRUISE VACATION DESTINATIONS</h2>
				</div>
			</div>
			<div class="row" style="background-color:#e0dada;">
				<div class="col-lg-12">
					<h3 class="text-center w3layouts w3 w3l w3ls">“BEST CRUISE LINE ITINERARIES”</h3>
					<p class="text-center w3layouts w3 w3l w3ls">— Recommend Magazine Reader's Choice Awards. 2004-2012, 2014-2015</p>
					<p class="text-center w3layouts w3 w3l w3ls"><a href="#">See what the experts say about Princess Cruises</a></p>
				</div>
			</div><br><br>
			<div class="row entertain container-fluid">
				<div class="col-lg-4">
					<a href="#">
						<img src="images/alaska.jpg" alt="">
						<p class="text-center w3layouts w3 w3l w3ls">ALASKA CRUISES AND LAND & SEA VACATIONS</p>
					</a>
				</div>
				<div class="col-lg-4">
					<a href="#">
						<img src="images/asia.jpg" alt="">
						<p class="text-center w3layouts w3 w3l w3ls">RASIA CRUISES</p>
					</a>
				</div>
				<div class="col-lg-4">
					<a href="#">
						<img src="images/caribbean.jpg" alt="">
						<p class="text-center w3layouts w3 w3l w3ls">CALIFORNIA & PACIFIC COAST CRUISES</p>
					</a>
				</div>
			</div>
				<div class="row entertain container-fluid">
				<div class="col-lg-4">
					<a href="#">
						<img src="images/coastals.jpg" alt="">
						<p class="text-center w3layouts w3 w3l w3ls">AUSTRALIA & NEW ZEALAND CRUISES</p>
					</a>
				</div>
				<div class="col-lg-4">
					<a href="#">
						<img src="images/europe.jpg" alt="">
						<p class="text-center w3layouts w3 w3l w3ls">EUROPE CRUISES</p>
					</a>
				</div>
				<div class="col-lg-4">
					<a href="#">
						<img src="images/Japan_640x400.jpg" alt="">
						<p class="text-center w3layouts w3 w3l w3ls">JAPAN CRUISES</p>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-4 footer-w3ls1">
					<h3>Learn About Cruising</h3>
					<p class="footer-p1">New to Cruising</p>
					<p class="footer-p1">Come Back New</p>
					<p class="footer-p1">NEW! Ocean Medallion™</p>
					<p class="footer-p1">Cruise Advice</p>
					<p class="footer-p1">Top 10 FAQ</p>
				</div>
				<div class="col-lg-4 col-md-4 footer-w3ls2">
					<h3>Subscribe</h3>
					<p class="footer-p1">Get the latest gist about Princess by subscribing to our news latter.</p>
					<div class="sub-w3ls">
			...
			<div class="row">
				...
				<div class="col-lg-5 copy-w3ls2">
					<p class="copyright">&copy; 2016 Ship Industry. All rights reserved</p>
				</div>
			</div>
		</div>
	</section>
